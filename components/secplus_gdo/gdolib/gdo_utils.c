...
const char* gdo_obstruction_state_to_string(gdo_obstruction_state_t state) {
    if (state < GDO_OBSTRUCTION_STATE_MAX) {
...
const char* gdo_light_action_to_string(gdo_light_action_t action) {
    if (action < GDO_LIGHT_ACTION_MAX) {
