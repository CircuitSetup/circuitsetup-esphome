...
#define GDOLIB_VERSION_MAJOR 1
#define GDOLIB_VERSION_MINOR 1
#define GDOLIB_VERSION_PATCH 0
#define GDOLIB_VERSION_STRING "1.1.0-cs1"

/*
 * Compatibility targets:
 * - ESP-IDF 5.1+ (native and Arduino-ESP32 backends used by ESPHome 2026.2.x)
 * - UART break generation uses official driver APIs when available, with a deterministic fallback.
 */
...
/**
 * @brief Returns the gdolib version string (semantic version with build suffix).
 */
const char *gdo_library_version(void);
